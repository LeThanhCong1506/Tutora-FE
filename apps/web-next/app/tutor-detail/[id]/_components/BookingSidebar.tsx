...
import type { AvailabilitySlot } from '@/services/tutorDetail.types';
      ...
      <div className="booking-card">
        <div className="booking-header">
          ...
          <div className="price-display">
            <b className="price-amount">
              {formatCurrency(hourlyRate ? Math.round(hourlyRate * 1.05) : null)}
            </b>
        ...
        <div className="booking-card-body">
          {hasAvailability ? (
            ...
            <div className="empty-availability">Chưa cập nhật lịch dạy</div>
          )}
        </div>
