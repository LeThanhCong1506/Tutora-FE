...
export default function HeroSection({ profile }: { profile: TutorFullProfile }) {
  ...
  const ytMatch = profile.videoIntroUrl?.match(
            ...
            <div className="rating-card">
              <div className="rating-stars">
                ...
                <b className="rating-text">
                  {(profile.averageRating || 0).toFixed(1)} ({profile.totalFeedbacks || 0} ĐÁNH GIÁ)
                </b>
              </div>
