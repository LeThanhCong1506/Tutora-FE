...
export interface CourseProgress {
   ...
   *
   * Không vào tử số (chưa chốt được là đã học xong), nhưng BẮT BUỘC có trong mẫu số: chúng vẫn
   * là buổi của gói đã mua. Bỏ chúng ra thì mẫu số của học sinh nhỏ hơn của gia sư đúng bằng số
   * buổi đang treo — cùng một lớp mà gia sư đọc "0/10 buổi" còn học sinh đọc "0/9 buổi".
