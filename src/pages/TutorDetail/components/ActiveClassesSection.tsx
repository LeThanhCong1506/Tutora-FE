import type { ActiveClassSummary } from '../../../services/tutorDetail.service';
    ...
    return (
        <section className="active-classes-section">
            ...
            <div className="active-classes-grid">
                {classes.map((cls) => {
                    const progress = cls.totalLessons > 0
                        ? Math.round((cls.completedLessons / cls.totalLessons) * 100)
                        : 0;
                        ...
                        <div key={cls.bookingId} className="active-class-card">
                            ...
                            <div className="active-class-student">
                                ...
                                <span className="student-name">
                                    {cls.studentName
                                        ? cls.studentName.split(' ').map((w, i, arr) =>
                                            i < arr.length - 1 ? w.charAt(0) + '.' : w
                                        ).join(' ')
                                        : '—'}
                                </span>
                            </div>
                            <div className="active-class-progress">
                                <div className="progress-info">
                                    <span>Tiến độ</span>
                                    <b>{cls.completedLessons}/{cls.totalLessons} buổi</b>
                                </div>
